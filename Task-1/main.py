#Deloitte Technology Virtual Experience Program - Task 1

"""
Objective:
Convert telemetry data from two different JSON formats
into a single unified schema for consistent processing.
"""
